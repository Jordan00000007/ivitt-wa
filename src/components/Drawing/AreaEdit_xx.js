...
const Rectangle = forwardRef(({ shapeProps, isSelected, onSelect, mediaWidth, mediaHeight, onBoxChange, isHover }, ref) => {
    ...
    const [myShape, setMyShape] = useState(shapeProps);
            ...
            <Html
                divProps={{
                    style: {
                        ...
                        width: '25px',
                        height: '25px',
                        left: (myShape.x + myShape.width -6)+'px',
                    },
                }}
            >
                <div style={{width:11,height:11,backgroundColor:'white',borderRadius:'50%',display:'inline-block',border:'2px solid blue'}}></div>
            </Html>
