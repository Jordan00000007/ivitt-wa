...
//import { selectCurrentBbox, setLabelIndex, setCurrentBbox, setImageName ,setClassInfo,setClassEditingIndex,setClassNameArr,setClassColorArr } from "../../redux/store/slice/currentBbox";
...
const CustomSelectClass = forwardRef((props, ref) => {
    ...
    // const classIdArr = useSelector(selectCurrentBbox).classIdArr;
    // const classNameArr = useSelector(selectCurrentBbox).classNameArr;
    // const classEditingIndex = useSelector(selectCurrentBbox).classEditingIndex;
    ...
    const CustomClassEditDialog= forwardRef((props, ref) => {

        const [isHover, setIsHover] = useState(false);

        const [classInfoItem, setClassInfoItem] = useState(props.data);
        ...
        const handleTextChange=(newName,oldName)=>{
            ...
            // const myClassNameArr=cloneDeep(classNameArr);
            // log('myClassNameArr')
            // log(myClassNameArr)

            // myClassNameArr[classEditingIndex]=newName;

            // log('myClassNameArr')
            // log(myClassNameArr)

            //dispatch(setClassNameArr(myClassNameArr))
        ...
        //     // log(classEditingIndex)
        //     // setClassInfoItem(classInfo[classEditingIndex]);
        //     log('classInfoItem')
        //     log(classInfoItem)
        //     if (classInfoItem.class_name){
        //         classNameRef.current.setInputValue(classInfoItem.class_name)
        //     }
                    ...
                    <div className='container'>
                        <div className='row' style={{padding:10}}>
                            <div className='col-12 p-0'>
                                <CustomInput width="180" height="34" onChange={handleTextChange} ref={classNameRef} defaultValue={props.data[props.dialogOrder].class_name}></CustomInput>
                            </div>
                        </div>
                        ...
                        <div className='row' style={{paddingTop:5,paddingLeft:10,paddingRight:10}}>
                            <div className='col-12 p-0'>
                                ...
                                <ColorfulPicker defaultColor={props.data[props.dialogOrder].color_hex} onChange={handleSetColor} ref={colorPaletteRef}></ColorfulPicker>
                            </div>
                        </div>
    ...
    const handleDialogOpen=(order,item)=>{    
        log('setClassEditingIndex='+order)
    ...
    const handleTextChange=(newName)=>{
        log('new Name')
        log(newName)
        ...
        props.onTextChange(newName,dialogOrder)
    }
...

                                {
                                    ...
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: 120, top: dialogTop }}>
                                            <CustomClassEditDialog data={props.data} dialogOrder={dialogOrder} onTextChange={handleTextChange} ref={editingPanelRef}>
