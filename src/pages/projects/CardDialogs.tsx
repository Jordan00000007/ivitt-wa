            ...
            <>
                {
                    ...
                    <Menu anchorEl={anchorMoreButton} open={Boolean(anchorMoreButton)} onClose={handleMenuClose} anchorReference="anchorEl"  autoFocus={false} anchorOrigin={{ vertical: 'bottom', horizontal: 'right', }}
                    >
...

                {
                    ...
                    <Menu anchorEl={anchorMoreButtonGlobal} open={Boolean(anchorMoreButtonGlobal)} onClose={handleMenuClose} anchorReference="anchorEl" autoFocus={false}  anchorOrigin={{ vertical: 'bottom', horizontal: 'right', }}
                    >
